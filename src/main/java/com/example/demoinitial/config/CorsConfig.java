...
/**
 * CORS configuration: CORS must be processed before Spring Security because the pre-flight
 * request will not contain any cookies.
...
public class CorsConfig {
    ...
    /**
     * This Option need does NOT NEED an explicit call to the http.cors().and() method in
     * WebSecurityConfig
     */
    @Bean
