...
public class WebSecurityConfig {
    ...
    @Autowired
    public WebSecurityConfig(UserDetailsServiceImpl userDetailsService, AuthEntryPointJwt
            unauthorizedHandler, JwtUtils jwtUtils) {
    ...
    public SecurityFilterChain jwtFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(antMatcher("/api/persons/**")).hasAnyRole("USER",
                                "MODERATOR", "ADMIN")
    ...
    protected SecurityFilterChain mvcFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> {
                            requests
                                    .requestMatchers(OPTIONS).permitAll()
                                    .requestMatchers(antMatcher("/users/**")).hasAnyRole("USER",
                                            "MODERATOR", "ADMIN")
                                    .requestMatchers(antMatcher("/stomp-broadcast/**")).hasAnyRole("USER",
                                            "MODERATOR", "ADMIN")
                                    .requestMatchers(antMatcher("/broadcast/**")).hasAnyRole("USER",
                                            "MODERATOR", "ADMIN")
