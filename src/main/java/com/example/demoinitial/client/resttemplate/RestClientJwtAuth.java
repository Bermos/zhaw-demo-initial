...
public class RestClientJwtAuth implements HasLogger {
    ...
    public void start() throws JsonProcessingException {
        ...
        ResponseEntity<Person> response = restTemplate.exchange(uri, HttpMethod.GET, request,
                Person.class);
    ...
    private String getLoginToken(String username, String password) throws JsonProcessingException {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity(autenticateUri, request,
                String.class);
